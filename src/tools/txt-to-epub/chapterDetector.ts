...
export function detectBookMetadata(text: string, fileName = ''): BookMetadata {
  const result: BookMetadata & { confidence: { title: string; author: string } } = {
    title: fileName || '',
    author: '',
