...
async function loadFontFile(fontId: string): Promise<ArrayBuffer> {
...
export async function subsetFont(
  ...
  try {
    const isOtf = config.file.endsWith('.otf');
    
    // fonteditor-core parses otf/ttf buffers
