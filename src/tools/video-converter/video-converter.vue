...
<template>
  <c-card>
    <div
      ...
      @drop.prevent="onDrop"
    >
      <!-- Drag overlay when dragging over existing video -->
      <div
        v-if="video && isOverDropZone"
      ...
      >
        ...
        <p class="text-lg font-bold text-primary">Drop new video to load</p>
      </div>
      ...
      >
        <div class="pointer-events-none flex flex-col items-center">
          ...
          <p class="text-lg font-medium text-gray-700 dark:text-gray-200">Click or drop video here</p>
